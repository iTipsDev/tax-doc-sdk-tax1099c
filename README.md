# tax-doc-sdk-tax1099c

Software development kit to generate IRS Form 1099-C as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1099C.sample.png" width="850"/>
