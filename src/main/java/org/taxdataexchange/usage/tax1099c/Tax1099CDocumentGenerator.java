...
import irs.fdxtax641.jsonserializers.Tax1099CSerializer;
import irs.fdxtax641.map2objects.Map2Tax1099C;
import org.taxdataexchange.core.pdfbuilders.Tax1099CPdfBuilder;
...
public class Tax1099CDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1099C obj = Map2Tax1099C.generate( row );
        {
            String asJson = Tax1099CSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1099C.csv";
        ...
        String outputFileName = "Tax1099C.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1099CDocumentGenerator generator = new Tax1099CDocumentGenerator( );
