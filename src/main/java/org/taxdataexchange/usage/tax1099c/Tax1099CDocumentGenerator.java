package org.taxdataexchange.usage.tax1099c;

import org.taxdataexchange.core.utils.*;
import org.taxdataexchange.docs.tax1099c.models.*;
import org.taxdataexchange.docs.tax1099c.utils.*;

public class Tax1099CDocumentGenerator {
    ...
    public static TaxDataList sampleData( ) {
        ...
        // Sample data
        // -----------------------------------------------------------------
        TaxData taxData = SampleData.sampleTaxData( "Tax1099C" );
    ...
    public static byte[] sampleQrAsPng( ) {
        ...
        Tax1099CPdfBuilder pdfBuilder = new Tax1099CPdfBuilder( );
        byte[] bytes = pdfBuilder.buildQr( taxDataList );

        String filePath = "samples/Tax1099C.qr.png";
    ...
    public static void samplePdf( ) {
        ...
        String filePath = "samples/Tax1099C.sample.pdf";
        FileUtils.bytesToFile( pdfBytes, filePath );
        System.out.println( filePath );

        String filePathPng = "samples/Tax1099C.sample.png";
    ...
    public static void addCoverPage() {
        ...
        String filePath2 = "samples/Tax1099C.cover.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void insertQrCode() {
        ...
        String filePath2 = "samples/Tax1099C.inserted.pdf";
        FileUtils.bytesToFile( combinedBytes, filePath2 );
    ...
    public static void main(String[] args) {
        ...
        System.out.println( "Tax1099CDocumentGenerator Begin" );
        ...
        System.out.println( "Tax1099CDocumentGenerator Done" );
